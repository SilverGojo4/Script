#!/bin/bash
#
# Please run "chmod +x ~/Script/bash/create_vscode_config.sh"
# This script creates a .vscode folder and a settings.json file in the specified path.
#
# To make this script easily accessible via a simple command, you can add a function in your .bashrc file.
#
...
#         return 1
#     fi
#     ~/Script/bash/create_vscode_config.sh "$1"
# }
#
# After editing your .bashrc file, run 'source ~/.bashrc' to apply the changes.
#
